...
public class JdbcBookShopWithJDBCTransaction implements BookShop {
	...
	public void purchase(String isbn, Integer userId) {
		...
		try {
			...
			// Add this line for JDBC Transaction Management
			...
			int rs3 = stmt3.executeUpdate("UPDATE ACCOUNT SET BALANCE = BALANCE -1 WHERE USERID =" + userId);
